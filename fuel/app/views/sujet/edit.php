<?php foreach($modif_sujet as $key): ?>
  <!-- Entête de la page -->
  <div class="container">
...
<div class="container" style="background-color: #F5F5F5;">
  ...
  if(array_key_exists('chronologie',$_GET)): $chronologie_check=$_GET['chronologie']; else: $chronologie_check=null; endif;
  if(array_key_exists('sexe',$_GET)): $sexe_check=$_GET['sexe']; else: $sexe_check=null; endif;
  if(array_key_exists('type_depot',$_GET)): $type_depot_check=$_GET['type_depot']; else: $type_depot_check=null; endif;
  if(array_key_exists('type_sepulture',$_GET)): $type_sepulture_check=$_GET['type_sepulture']; else: $type_sepulture_check=null; endif;
  if(array_key_exists('contexte_normatif',$_GET)): $contexte_normatif_check=$_GET['contexte_normatif']; else: $contexte_normatif_check=null; endif;
  if(array_key_exists('milieu_vie',$_GET)): $milieu_vie_check=$_GET['milieu_vie']; else: $milieu_vie_check=null; endif;
  if(array_key_exists('contexte',$_GET)): $contexte_check=$_GET['contexte']; else: $contexte_check=null; endif;
  ...
  if(!empty($datation[0])): $datation_debut= $datation[0][0]; $datation_fin= $datation[0][1]; else: $datation_debut=0; $datation_fin=0; endif;
  ...
  if (!empty($depot_sujet)):
    ...
    <div class="row" style="margin-bottom: 5px;">
      <div class="col-md-6">
        <div class="form-floating">
          <input type="number" class="form-control" name="NMI" placeholder="183" value="<?php if(array_key_exists('NMI',$_GET)): echo $_GET['NMI']; else: echo $NMI; endif; ?>">
          <?= Form::label('NMI', 'NMI' ); ?>
        </div>
      </div>
      <div class="col-md-6">
    ...
    <div class="row my-2">
      <div class="col-md-6">
        <div class="form-floating">
          <input type="text" class="form-control" name="id_sujet" placeholder="183" value="<?php if(array_key_exists('id_sujet',$_GET)): echo $_GET['id_sujet']; else: echo $key['id_sujet_handicape']; endif; ?>">
      ...
      <div class="col-md-6">
        <div class="form-floating">
          <select class="form-select" name="sexe" aria-label="select_sexe">
            <option value="">Sélectionner</option>
            <option value="Femme"<?php if (($sexe_check == "Femme") || ($key['sexe'] == "Femme")): echo ' selected'; endif;?>>Femme
          </option>
          <option value="Homme"<?php if (($sexe_check == "Homme") || ($key['sexe'] == "Homme")): echo ' selected'; endif;?>>Homme
        </option>
        <option value="Indéterminé"<?php if (($sexe_check == "Indéterminé") || ($key['sexe'] == "Indéterminé")): echo ' selected'; endif;?>>Indéterminé
      </option>
    </select>
...
<div class="row my-2">
  <div class="col-md-6">
    <div class="form-floating">
      <input type="number" class="form-control" min="0" max="130" name="age_min" placeholder="183" value="<?php if(array_key_exists('age_min',$_GET)): echo $_GET['age_min']; else: echo  $key['age_min']; endif; ?>">
      <?= Form::label('Age minimum au décès', 'age_min' ); ?>
    </div>
  </div>
  <div class="col-md-6">
    <div class="form-floating">
      <input type="number" class="form-control" min="0" max="130" name="age_max" placeholder="183" value="<?php if(array_key_exists('age_max',$_GET)): echo $_GET['age_max']; else: echo  $key['age_max']; endif; ?>">
...
<div class="row my-2">
  <div class="col-md-6">
    <div class="form-floating">
      <input type="number" class="form-control" name="datation_debut" placeholder="183" value="<?php if(array_key_exists('datation_debut',$_GET)): echo $_GET['datation_debut']; else: echo $datation_debut; endif;  ?>">
      <?= Form::label('Datation début', 'datation_debut' ); ?>
    </div>
  </div>
  <div class="col-md-6">
    <div class="form-floating">
      <input type="number" class="form-control" name="datation_fin" placeholder="183" value="<?php if(array_key_exists('datation',$_GET)): echo $_GET['datation']; else: echo $datation_fin; endif;  ?>">
  ...
  <div class="col-md-4">
    <div class="form-floating">
      <select class="form-select" name="contexte_normatif" aria-label="select_contexte_normatif" style="margin-top: 2.5%;margin-bottom: 2.5%;">
        <option value="">Sélectionner</option>
        <option value="Standard"<?php if (($contexte_normatif_check  == "Standard") || ($key['contexte_normatif'] == "Standard")): echo ' selected'; endif;?>>Standard</option>
      <option value="Atypique"<?php if (($contexte_normatif_check  == "Atypique") || ($key['contexte_normatif'] == "Atypique")): echo ' selected'; endif;?>>Atypique</option>
  </select>
  ...
  <div class="col-md-6">
    <div class="form-floating">
      <select class="form-select" name="milieu_vie" aria-label="select_milieu_vie">
        <option value="">Sélectionner</option>
        <option value="Rural"<?php if (($milieu_vie_check == "Rural") || ($key['milieu_vie']== "Rural")): echo ' selected'; endif;?>>Rural</option>
      <option value="Urbain"<?php if (($milieu_vie_check == "Urbain") || ($key['milieu_vie']== "Urbain")): echo ' selected'; endif;?>>Urbain</option>
  </select>
...
<div class="col-md-6">
  <div class="form-floating">
    <select class="form-select" name="contexte" aria-label="select_contexte">
      <option value="">Sélectionner</option>
      <option value="Funeraire"<?php if (($contexte_check == "Funeraire") || ($key['contexte'] == "Funeraire") ): echo 'selected'; endif;?>>Funéraire</option>
    <option value="Domestique"<?php if (($contexte_check == "Domestique") ||  ($key['contexte'] == "Domestique")): echo 'selected'; endif;?>>Domestique</option>
  <option value="Autre"<?php if (($contexte_check == "Autre") ||  ($key['contexte'] == "Autre")): echo 'selected'; endif;?>>Autre</option>
</select>
...
<div class="col-md-12">
  ...
  <div class="input-group">
    <textarea class="form-control" name="commentaire_contexte" rows="2"><?php if(array_key_exists('commentaire_contexte',$_GET)): echo $_GET['commentaire_contexte']; else: echo $key['commentaire_contexte']; endif;?></textarea>
  </div>
</div>
<?php endforeach;?>
<div class="container">
  <div class="row">
    <div class="col-md-4">
      ...
      <?php foreach ($accessoire as $key) {
        ...
        if($key['name'] == "autre_mobilier"): echo'id="autre_mobilier" onchange="function_toggle();"'; endif;
        if(array_key_exists('erreur', $_GET)):
          if($key['id'] == 1 && array_key_exists('accessoire_vestimentaire_et_parure',$_GET)): echo "checked"; endif;
          if($key['id'] == 2 && array_key_exists('armement_objet_de_prestige',$_GET)): echo "checked"; endif;
          if($key['id'] == 3 && array_key_exists('depot_de_recipient',$_GET)): echo "checked"; endif;
          if($key['id'] == 4 && array_key_exists('autre_mobilier',$_GET)): echo "checked"; $d_none_descp_autre_mobilier=""; $description_autre_mobilier=$_GET['description_autre_mobilier']; else: $d_none_descp_autre_mobilier="d-none"; $description_autre_mobilier="";  endif;
          else: if(!empty($accessoire_sujet)): foreach ($accessoire_sujet as $key2) {
            if($key2['id_mobilier'] == $key['id']): echo "checked";endif;
            if($key2['id_mobilier'] == 4): $d_none_descp_autre_mobilier=""; $description_autre_mobilier=$key2['description']; endif;
          }
          else: $d_none_descp_autre_mobilier="d-none"; $description_autre_mobilier=""; endif;
        endif;
        echo'>
        </div>';
      }?>
  ...
  <div class="col-md-8">
    ...
    <div class="row row-cols-2">
      <div class="col">
        <div class="form-floating">
          <input type="text" class="form-control" name="num_inventaire" placeholder="Numéro" value="<?php if(array_key_exists('num_inventaire',$_GET)): echo $_GET['num_inventaire']; else: echo $num_inventaire; endif;?>">
          <label for="num_inventaire">Numéro du dépôt</label>
        </div>
      </div>
      <div class="col">
        <div class="form-floating">
          <input type="text" name="commune_depot" id="commune_depot" class="form-control" placeholder="Rechercher une commune ..." autocomplete="off" value="<?php if(array_key_exists('commune_depot',$_GET)): echo $_GET['commune_depot']; else: echo $nom_commune_depot; endif;?>">
      ...
      <div class="col my-2">
        <div class="form-floating">
          <input type="text" class="form-control" name="adresse_depot" placeholder="Adresse" value="<?php if(array_key_exists('adresse_depot',$_GET)): echo $_GET['adresse_depot']; else: echo $adresse_depot; endif;?>">
  ...
  <div class="row">
    <?php foreach ($diagnostic as $key) {
      ...
      if($key['nom'] == "Pathologie infectieuse"): echo ' id="pathologies_infectieuses"';
        elseif($key['nom'] == "Autre"): echo '  id="autre_atteinte"'; endif;
        echo 'name="'.$key['name'].'" value="'.$key['id'].'"';
        if($key['nom'] == "Pathologie infectieuse"): echo ' onchange="function_toggle();"'; endif;
        if($key['nom'] == "Autre"): echo ' onchange="function_toggle();"'; endif;

        if(array_key_exists('erreur', $_GET)):
          if($key['id'] == 1 && array_key_exists('trepanation',$_GET)): echo"checked"; endif;
          if($key['id'] == 2 && array_key_exists('edentement_complet',$_GET)): echo"checked"; endif;
          if($key['id'] == 3 && array_key_exists('atteinte_neurale',$_GET)): echo"checked"; endif;
          if($key['id'] == 4 && array_key_exists('scoliose_severe',$_GET)): echo"checked"; endif;
          if($key['id'] == 5 && array_key_exists('paget',$_GET)): echo"checked"; endif;
          if($key['id'] == 6 && array_key_exists('dish',$_GET)): echo"checked"; endif;
          if($key['id'] == 7 && array_key_exists('rachitisme',$_GET)): echo"checked"; endif;
          if($key['id'] == 8 && array_key_exists('nanisme',$_GET)): echo"checked"; endif;
          if($key['id'] == 9 && array_key_exists('pathologie_infectieuse',$_GET)): echo"checked"; $d_none_pathologie=""; else:  $d_none_pathologie="d-none";  endif;
          if($key['id'] == 10 && array_key_exists('fracture_non_reduite',$_GET)): echo"checked"; endif;
          if($key['id'] == 11 && array_key_exists('amputation',$_GET)): echo"checked"; endif;
          if($key['id'] == 12 && array_key_exists('pathologie_severe',$_GET)): echo"checked"; endif;
          if($key['id'] == 13 && array_key_exists('autre_atteinte',$_GET)): echo"checked"; $d_none_autre_atteinte=""; $description_autre_atteinte=$_GET['description_autre_atteinte']; else: $d_none_autre_atteinte="d-none"; $description_autre_atteinte="";  endif;
          else: if(!empty($atteinte_invalidante_sujet)): foreach ($atteinte_invalidante_sujet as $key2) {
            $description_autre_atteinte="";
            if($key2['id_diagnostic'] == $key['id']): echo "checked"; endif;
            if($key2['id_diagnostic'] == 9): $d_none_pathologie=""; endif;
            if($key2['id_diagnostic'] == 13): $d_none_autre_atteinte=""; $description_autre_atteinte=$key2['description_autre']; endif;
          }
          else: $d_none_pathologie=$d_none_autre_atteinte="d-none"; $description_autre_atteinte=""; endif;
        endif;
        echo'>
        </div>';
        if($key['nom'] == "Pathologie infectieuse"): 
          ...
          foreach ($pathologie as $key2) {
            ...
            if(array_key_exists('erreur', $_GET)):
              if($key2['id_pathologie'] == 1 && array_key_exists('PI_lepre',$_GET)): echo'checked'; endif;
              if($key2['id_pathologie'] == 2 && array_key_exists('PI_syphilis',$_GET)): echo'checked'; endif;
              if($key2['id_pathologie'] == 3 && array_key_exists('PI_variole',$_GET)): echo'checked'; endif;
              if($key2['id_pathologie'] == 4 && array_key_exists('PI_autre_pathologie_infectieuse',$_GET)): echo'checked'; endif;
              else: if(!empty($atteinte_invalidante_sujet)): foreach ($atteinte_invalidante_sujet as $key3) {
                if($key3['id_pathologie'] == $key2['id_pathologie']): echo "checked"; endif;
              }
            endif;
          endif;
          echo '>
      ...
      if($key['name'] == "trepanation"):
       ...
       if($key['name'] != "trepanation" && $key['name'] != "edentement_complet"): 
        ...
        foreach ($localisation_atteinte as $key2) {
          ...
          if(array_key_exists('erreur', $_GET)):
            if($key2['id'] == 1 && array_key_exists('crane_'.$key['id'],$_GET)): echo"checked"; endif;
            if($key2['id'] == 2 && array_key_exists('msd_'.$key['id'],$_GET)): echo"checked"; endif;
            if($key2['id'] == 3 && array_key_exists('msg_'.$key['id'],$_GET)): echo"checked"; endif;
            if($key2['id'] == 4 && array_key_exists('tronc_bassin_'.$key['id'],$_GET)): echo"checked"; endif;
            if($key2['id'] == 5 && array_key_exists('mid_'.$key['id'],$_GET)): echo"checked"; endif;
            if($key2['id'] == 6 && array_key_exists('mig_'.$key['id'],$_GET)): echo"checked"; endif;
            else: if(!empty($localisation_sujet)): foreach ($localisation_sujet as $key3) {
              if($key['id'] == $key3['id_diagnostic']): if($key3['id_localisation_atteinte'] == $key2['id']): echo 'checked'; endif; endif;
            }
          endif;
        endif;
        echo'>
      ...
      foreach ($appareil_compensatoire as $key2) {
        ...
        if(array_key_exists('erreur', $_GET)):
          if($key2['id_appareil_compensatoire'] == 1 && array_key_exists('attele_'.$key['id'],$_GET)): echo"checked"; endif;
          if($key2['id_appareil_compensatoire'] == 2 && array_key_exists('prothese_'.$key['id'],$_GET)): echo"checked"; endif;
          if($key2['id_appareil_compensatoire'] == 3 && array_key_exists('orthese_'.$key['id'],$_GET)): echo"checked"; endif;
          if($key2['id_appareil_compensatoire'] == 4 && array_key_exists('bequillage_'.$key['id'],$_GET)): echo"checked"; endif;
          else: if(!empty($appareil_sujet)): foreach ($appareil_sujet as $key3) {
            if($key['id'] == $key3['id_diagnostic']): if($key3['id_appareil_compensatoire'] == $key2['id_appareil_compensatoire']): echo 'checked'; endif; endif;
            $commentaire_appareil=$key3['commentaire'];
          }
          else: $commentaire_appareil=""; endif;
        endif;
        echo'>
        </div>';
      }
    ...
    <textarea class="form-control" name="commentaire_appareil" rows="2">';if(array_key_exists('commentaire_appareil',$_GET)): echo $_GET['commentaire_appareil']; else: echo $commentaire_appareil; endif;
    echo'</textarea>';
    echo'
    <label for="commentaire_diagnostic">Commentaire du diagnostic</label>
    <textarea class="form-control" name="commentaire_diagnostic" rows="2" placeholder="** INFO ** Les différentes atteintes cochées seront ajoutées à la description">';if(array_key_exists('commentaire_diagnostic',$_GET)): echo $_GET['commentaire_diagnostic']; else: echo $commentaire_diagnostic; endif;
    echo'</textarea>
    </div>
    </div>
    <br/>';
