    ...
    <div style="background-color: #F5F5F5;">
      <div class="row g-2">
          ...
          <div class="col-md-6">
            <div class="form-floating">
              <input type="text" class="form-control" name="adresse" placeholder="Adresse" value="<?php
                                                                                                  if (array_key_exists('adresse', $_GET)) : echo $_GET['adresse'];
                                                                                                  else : null;
                                                                                                  endif; ?>">
        ...
        <div class="row g-2">
          <div class="col-md-6">
            <div class="form-floating">
              <input type="number" class="form-control" name="X" placeholder="50" value="<?php if (array_key_exists('X', $_GET)) : echo $_GET['X'];
                                                                                          else : null;
                                                                                          endif; ?>">
          ...
          <div class="col-md-6">
            <div class="form-floating">
              <input type="number" class="form-control" name="Y" placeholder="50" value="<?php if (array_key_exists('Y', $_GET)) : echo $_GET['Y'];
                                                                                          else : null;
                                                                                          endif; ?>">
      ...
      <div class="row g-2">
        ...
        <div class="row g-2">
          <div class="col-md-6">
            <div class="form-floating">
              <input type="text" class="form-control" name="anthropologue[]" placeholder="Nom Prénom" value="<?php if (array_key_exists('anthropologue', $_GET)) : echo $_GET['anthropologue'];
                                                                                                              else : null;
                                                                                                              endif; ?>">
        ...
        <div class="row g-2">
          <div class="col-md-6">
            <div class="form-floating">
              <input type="text" class="form-control" name="paleopathologiste[]" placeholder="Nom Prénom" value="<?php if (array_key_exists('paleopathologiste', $_GET)) : echo $_GET['paleopathologiste'];
                                                                                                                  else : null;
                                                                                                                  endif; ?>">
...
<div class="d-none" id="ajout_sujet_handicape">
  <div class="container">
    ...
    <h4>Opération: <?php if (array_key_exists('nom', $_GET)) : echo $_GET['nom'];
                    else : echo $nom_op;
                    endif; ?></h4>
    ...
    <div class="container" style="background-color: #F5F5F5;">
      ...
      <input name="id_operation" type="hidden" value="<?php if (array_key_exists('op', $_GET)) : echo $_GET['op'];
                                                      else : echo $id_operation;
                                                      endif; ?>">
      <input name="nom_op" type="hidden" value="<?php if (array_key_exists('nom', $_GET)) : echo $_GET['nom'];
                                                else : echo $nom_op;
                                                endif; ?>">
      <div class="d-grid gap-2 d-md-flex justify-content-md-end" style="margin-top: 10px;">
