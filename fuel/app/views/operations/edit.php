...
foreach($modif_op as $key): ?>
  <!-- Entête de la page -->
<div class="container">
  <h1 class="m-2">Modifier l'opération <?= $key['nom_op'] ?>
    <a class="btn btn-sm btn-secondary" href="/public/operations/edit/<?= $key['id_site'] ?>">Rafraichir la page 
      <i class="bi bi-arrow-repeat"></i>
    </a>
  </h1>
  <p class="text-muted">Ici vous pouvez modifier une opération.</p>
</div>
<?= Form::open(array('action'=>'operations/edit/'.$key['id_site'].'','method'=>'POST'));
 ...
 //Permet de récupérer le nom commune
  $query = DB::query('SELECT nom FROM commune WHERE id='.$key['id_commune'].'   ');
  ...
  <div class="row my-2 pt-1">
    <div class="col-md-6">
      <div class="form-floating">
        <input type="text" class="form-control" name="adresse" placeholder="Adresse" value="<?php if(array_key_exists('adresse',$_GET)): echo $_GET['adresse']; else: echo $key['adresse']; endif; ?>">
          <?= Form::label('Adresse', 'adresse'); ?>
        </div>
      </div>
      <div class="col-md-6">
        <div class="form-floating">
          <input type="number" class="form-control" name="annee" placeholder="1910" value="<?php if(array_key_exists('annee',$_GET)): echo $_GET['annee']; else: echo $key['annee']; endif; ?>">
      ...
      <div class="row my-2">
        <div class="col-md-6">
          <div class="form-floating">
            <input type="number" class="form-control" name="X" step="any" value="<?php if(array_key_exists('X',$_GET)): echo $_GET['X']; else: echo $key['X']; endif; ?>">
              <?= Form::label('Position X', 'X'); ?>
            </div>
          </div>
          <div class="col-md-6">
            <div class="form-floating">
              <input type="number" class="form-control" name="Y" step="any" placeholder="50" value="<?php if(array_key_exists('Y',$_GET)): echo $_GET['Y']; else: echo $key['Y']; endif; ?>">
          ...
          <div class="col-md-12">
            ...
            <textarea class="form-control" id="a_revoir" name="a_revoir"><?php if(array_key_exists('a_revoir',$_GET)): echo $_GET['a_revoir']; else: echo $key['a_revoir']; endif;?></textarea>
          </div>
          <div class="row">
            <div class="col-md-4">
              <div class="form-floating">
              ...
              <div class="col-md-4">
                <div class="form-floating">
                  <select class="form-select my-4" name="organisme">
                    ...
                    <?php foreach($all_organisme as $key_org):
              echo '<option value="'.$key_org['id'].'"';
              if (($organisme_check == $key_org['id']) || ($key['id_organisme'] == $key_org['id'])){
                echo 'selected';
              }
              echo '>'.$key_org['nom'].'</option>';
            endforeach;
            ?>
                  </select>
              ...
              <div class="col-md-4">
                <div class="form-floating">
                  <select class="form-select my-4" name="type_operation">
                    <option value="">Sélectionner</option>
                    <?php foreach($all_type_op as $key_type_op):
                echo '<option value="'.$key_type_op['id'].'"';
                if (($type_op_check == $key_type_op['id'])||($key['id_type_op'] == $key_type_op['id'])){
                  echo 'selected';
                }
                echo '>'.$key_type_op['nom'].'</option>';
              endforeach;
              ?>
                  </select>
            ...
            <div class="row my-2">
              <div class="col-md-6">
                <div class="form-floating">
                  <input type="text" class="form-control" name="EA" placeholder="exemple" value="<?php if(array_key_exists('EA',$_GET)): echo $_GET['EA']; else: echo $key['EA']; endif; ?>">
                    <?= Form::label('EA', 'EA'); ?>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-floating">
                    <input type="text" class="form-control" name="OA" placeholder="exemple" value="<?php if(array_key_exists('OA',$_GET)): echo $_GET['OA']; else: echo $key['OA']; endif; ?>">
                      <?= Form::label('OA', 'OA'); ?>
                    </div>
                  </div>
                </div>
                <div class="row my-2">
                  <div class="col-md-6">
                    <div class="form-floating">
                      <input type="text" class="form-control" name="patriarche" placeholder="exemple" value="<?php if(array_key_exists('patriarche',$_GET)): echo $_GET['patriarche']; else: echo $key['patriarche']; endif; ?>">
                        <?= Form::label('Patriarche', 'patriarche'); ?>
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-floating">
                        <input type="text" class="form-control" name="numero_operation" placeholder="exemple" value="<?php if(array_key_exists('numero_op',$_GET)): echo $_GET['numero_op']; else: echo $key['numero_operation']; endif; ?>">
                    ...
                    <div class="row my-2">
                      <div class="col-md-6">
                        <div class="form-floating">
                          <input type="text" class="form-control" name="arrete_prescription" placeholder="exemple" value="<?php if(array_key_exists('arrete_prescription',$_GET)): echo $_GET['arrete_prescription']; else: echo $key['arrete_prescription']; endif;?>">
                            <?= Form::label('Arrêté de prescription', 'arrete_prescription'); ?>
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div class="form-floating">
                            <input type="text" class="form-control" name="responsable_op" placeholder="exemple" value="<?php if(array_key_exists('responsable_op',$_GET)): echo $_GET['responsable_op']; else: echo $key['responsable_op']; endif; ?>">
                        ...
                        <div class="row my-2">
                          <div class="col-md-6">
                            <div class="form-floating">
                              <input type="text" class="form-control" name="anthropologue" placeholder="Nom Prénom, etc." value="<?php if(array_key_exists('anthropologue',$_GET)): echo $_GET['anthropologue']; else: echo $key['anthropologue']; endif; ?>">
                                <?= Form::label('Anthropologue (Nom Prénom, etc.)', 'anthropologue'); ?>
                              </div>
                            </div>
                            <div class="col-md-6">
                              <div class="form-floating">
                                <input type="text" class="form-control" name="paleopathologiste" placeholder="Nom Prénom, etc." value="<?php if(array_key_exists('paleopathologiste',$_GET)): echo $_GET['paleopathologiste']; else: $key['paleopathologiste']; endif; ?>">
                            ...
                            <div class="col-md-12">
                              ...
                              <div class="input-group">
                                <textarea class="form-control" name="bibliographie" rows="2"><?php if(array_key_exists('bibliographie',$_GET)): echo $_GET['bibliographie']; else: echo $key['bibliographie']; endif;?></textarea>
                              </div>
                            </div>
                            <br/>
