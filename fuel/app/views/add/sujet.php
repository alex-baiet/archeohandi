...
function afficherLigne($noLigne,$chronologie,$type_depot,$type_sepulture,$diagnostic,$accessoire,$localisation_atteinte,$appareil_compensatoire,$pathologie,$para){
  ...
  if(array_key_exists('crane_'.$noLigne,$_GET)): $crane='checked'; else: $crane=null; endif;
  if(array_key_exists('msd_'.$noLigne,$_GET)): $msd='checked'; else: $msd=null; endif;
  if(array_key_exists('msg_'.$noLigne,$_GET)): $msg='checked'; else: $msg=null; endif;
  if(array_key_exists('tronc_bassin_'.$noLigne,$_GET)): $tronc_bassin='checked'; else: $tronc_bassin=null; endif;
  if(array_key_exists('mid_'.$noLigne,$_GET)): $mid='checked'; else: $mid=null; endif;
  if(array_key_exists('mig_'.$noLigne,$_GET)): $mig='checked'; else: $mig=null; endif;

  if(array_key_exists('attele_'.$noLigne,$_GET)): $attele='checked'; else: $attele=null; endif;
  if(array_key_exists('prothese_'.$noLigne,$_GET)): $prothese='checked'; else: $prothese=null; endif;
  if(array_key_exists('orthese_'.$noLigne,$_GET)): $orthese='checked'; else: $orthese=null; endif;
  if(array_key_exists('bequillage_'.$noLigne,$_GET)): $bequillage='checked'; else: $bequillage=null; endif;
