...
else: $commentaire_diagnostic_sujet=""; endif;
else: $commentaire_diagnostic_sujet=""; endif;
...
for($a=1; $a<=13; $a++): $localisation[$a]=array(); $appareil[$a]=array(); endfor; 
...
if(is_numeric(Input::post('NMI'))): $valeurs.='&NMI='.Input::post('NMI'); $NMI=Input::post('NMI'); else: $erreurs.="&erreur_NMI"; endif;
else: $erreurs.="&erreur_NMI_vide"; endif;
...
if(!empty($if_chrono_ex)): $valeurs.='&chronologie='.Input::post('nom_chronologie'); $periode_chrono=Input::post('nom_chronologie'); else: $erreurs.="&erreur_chrono"; endif;
else: $erreurs.="&erreur_chrono_vide"; endif;
...
else: $erreurs.="&erreur_alpha_sujet"; endif;
else: $erreurs.="&erreur_sujet_vide"; endif;

if(Input::post('sexe') != NULL):
if(Input::post('sexe') == "Femme" || Input::post('sexe')=="Homme" || Input::post('sexe')=="Indéterminé" ): $valeurs.='&sexe='.Input::post('sexe'); $sexe=Input::post('sexe'); else: $erreurs.="&erreur_sexe"; endif;
else: $erreurs.="&erreur_sexe_vide"; endif;

if(!empty(Input::post('age_min'))):
if(is_numeric(Input::post('age_min')) && Input::post('age_min')> 0 && Input::post('age_min') <130): $valeurs.='&age_min='.Input::post('age_min'); $age_min=Input::post('age_min'); else: $erreurs.="&erreur_age_min"; endif;
else: $age_min=""; endif;

if(!empty(Input::post('age_max'))):
if(is_numeric(Input::post('age_max')) && Input::post('age_max')> 0 && Input::post('age_max') <130 && Input::post('age_max') > $age_min): $valeurs.='&age_max='.Input::post('age_max'); $age_max=Input::post('age_max'); else: $erreurs.="&erreur_age_max"; endif;
else: $age_max=""; endif;

if(!empty(Input::post('datation_debut'))):
if(is_numeric(Input::post('datation_debut'))): $valeurs.='&datation_debut='.Input::post('datation_debut'); $datation_debut=Input::post('datation_debut') ; else: $erreurs.="&erreur_datation_debut"; endif;
else: $datation_debut=""; endif;

if(!empty(Input::post('datation_fin'))):
if(is_numeric(Input::post('datation_fin')) && Input::post('datation_fin') > $datation_debut): 	$valeurs.='&datation_fin='.Input::post('datation_fin'); $datation_fin=Input::post('datation_fin'); else: $erreurs.="&erreur_datation_fin"; endif;
else: $datation_fin=""; endif;
...
if(!empty($if_depot_ex)): $valeurs.='&type_depot='.Input::post('type_depot'); $type_depot=Input::post('type_depot'); else: $erreurs.="&erreur_depot"; endif;
else: $erreurs.="&erreur_depot_vide"; endif;
...
if(!empty($if_sepulture_ex)): 	$valeurs.='&type_sepulture='.Input::post('type_sepulture'); $type_sepulture=Input::post('type_sepulture'); else: $erreurs.="&erreur_sepulture"; endif;
else: $erreurs.="&erreur_sepulture_vide"; endif;

if(Input::post('contexte_normatif') != NULL):
if(Input::post('contexte_normatif') == "Standard" || Input::post('contexte_normatif') == "Atypique"): $valeurs.='&contexte_normatif='.Input::post('contexte_normatif'); $contexte_normatif=Input::post('contexte_normatif'); else: $erreurs.="&erreur_contexte_normatif"; endif;
else: $contexte_normatif=""; endif;

if(Input::post('milieu_vie') != NULL):
if(Input::post('milieu_vie') == "Rural" || Input::post('milieu_vie') == "Urbain"): $valeurs.='&milieu_vie='.Input::post('milieu_vie'); $milieu_vie=Input::post('milieu_vie'); else: $erreurs.="&erreur_milieu_vie"; endif;
else: $milieu_vie=""; endif;

if(Input::post('contexte') != NULL):
if(Input::post('contexte') == "Funeraire" || Input::post('contexte') == "Domestique" || Input::post('contexte') == "Autre"): $valeurs.='&contexte='.Input::post('contexte'); $contexte=Input::post('contexte'); else: $erreurs.="&erreur_contexte"; endif;
else: $contexte=""; endif;
...
else: $commentaire_contexte=""; endif;
...
else: $accessoire_vesti=NULL; endif;
...
else: $erreurs.="&erreur_description_mobilier_vide"; endif;
else: $autre_mobilier=NULL; endif;          
...
else: $erreurs.="&erreur_alpha_num_inventaire"; endif;
else: $num_inventaire=NULL; endif;
...
if (!empty($if_commune_depot_ex)): $valeurs.='&commune_depot='.$nom_commune_depot; $id_commune_depot=$if_commune_depot_ex[0]['id']; else: $erreurs.="&erreur_commune_depot"; endif;
else: $id_commune_depot=NULL; endif;
...
else: $erreurs.="&erreur_alpha_adresse_depot"; endif;
else: $adresse_depot=NULL; endif;
...
else: $edentement_complet=NULL; endif;
...
else: $atteinte_neurale=NULL; endif;
...
else: $scoliose_severe=NULL; endif;
...
//Ajout du nom de la pathologie dans le tableau permettant de construire la phrase qui s'ajoute au commentaire du diagnostic 
array_push($description_patho_tab, 'Lèpre'); else: $lepre=NULL; endif;
if(Input::post('PI_syphilis') != NULL):
$valeurs.='&PI_syphilis'; 
$syphilis= Input::post('PI_syphilis');
//Ajout du nom de la pathologie dans le tableau permettant de construire la phrase qui s'ajoute au commentaire du diagnostic 
array_push($description_patho_tab, 'Syphilis'); else: $syphilis=NULL; endif;
if(Input::post('PI_variole') != NULL): 
$valeurs.='&PI_variole'; 
$variole=Input::post('PI_variole');
//Ajout du nom de la pathologie dans le tableau permettant de construire la phrase qui s'ajoute au commentaire du diagnostic  
array_push($description_patho_tab, 'Variole'); else: $variole=NULL; endif;
if(Input::post('PI_tuberculose') != NULL): 
$valeurs.='&PI_tuberculose'; 
$tuberculose= Input::post('PI_tuberculose');
//Ajout du nom de la pathologie dans le tableau permettant de construire la phrase qui s'ajoute au commentaire du diagnostic 
array_push($description_patho_tab, 'Tuberculose'); else: $tuberculose=NULL; endif;
...
//Ajout du nom de la pathologie dans le tableau permettant de construire la phrase qui s'ajoute au commentaire du diagnostic 
array_push($description_patho_tab, 'Autre pathologie'); else: $autre_patho_infectieuse=NULL; endif;

else: $erreurs.='&erreur_pathologie'; endif; 
else: $pathologie_infectieuse=NULL; endif;
...
else: $fracture_non_reduite=NULL; endif;
...
else: $pathologie_severe=NULL; endif;
...
else: $erreurs.="&erreur_description_autre_atteinte"; endif;   
else: $autre_atteinte=NULL; endif;
...
if(array_key_last($description_patho_tab) == $key2): $ajout_description_diagnostic.= " ".$val2.'. ';  else: $ajout_description_diagnostic.= $val2.', '; endif;
endforeach;
elseif ($val == "Autre atteinte"):
$ajout_description_diagnostic.= $val.': ';
else: $ajout_description_diagnostic.= $val.', '; endif;
...
else: $commentaire_diagnostic=$ajout_description_diagnostic; endif;
endforeach;
else: $commentaire_diagnostic=""; endif;
