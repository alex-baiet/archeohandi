...
/**
 * Classe permettant d'exploiter l'API de Nakala.
 * @see https://gitlab.huma-num.fr/bdavid/nakala-in-php/
 */
class Nakala
{

	// define the server url
	private static $server_url = "https://api.nakala.fr";
	// and your access key
	private static $option_key = "X-API-KEY: 6f916df0-ba8c-3d5a-f1c3-df4bbaa0b396";
	 ...
	 * 
	 * extension possible : jpg, png, svg, pdf, mp4, ply, blend.
	 */
	public static function setMediaType($file_extension)
	{
	...
	public static function mycUrl($cmd)
	{
		$server_url = Nakala::$server_url;
		$option_key = Nakala::$option_key;
	...
	public static function postDatasUpload($file_name, $file_extension)
	{
		$server_url = Nakala::$server_url;
		$option_key = Nakala::$option_key;
		$document_type = Nakala::setMediaType($file_extension);
	 ...
	 */
	public static function postDataMetadatas($sha1_file, string $description = '')
	{
		$server_url = Nakala::$server_url;
		$option_key = Nakala::$option_key;
	 ...
	 */
	public static function postDatasFiles($identifier, $sha1_file, $description, $embargo_date)
	{
		$server_url = Nakala::$server_url;
		$option_key = Nakala::$option_key;
	...
	public static function getDataFiles($identifier)
	{
		$server_url = Nakala::$server_url;
		$option_key = Nakala::$option_key;
	...
	public static function getDataMetadatas($identifier)
	{
		$server_url = Nakala::$server_url;
		$option_key = Nakala::$option_key;
	...
	public static function postCollections($collection_name)
	{
		$server_url = Nakala::$server_url;
		$option_key = Nakala::$option_key;
	...
	public static function getCollections($identifier)
	{
		$server_url = Nakala::$server_url;
		$option_key = Nakala::$option_key;
	...
	public static function test()
	{
		...
		$file_extension = 'jpg';
		$sha1 = Nakala::postDatasUpload($original_filename, $file_extension);

		// Define metadatas for previous uploaded file
		$payload = Nakala::postDataMetadatas($sha1, 'le mauvais œil'); // on définit ici la description
		...
		$dr = Nakala::postDatasFiles($identifier, $sha1, $description, $embargo_date);
		var_dump($dr);

		$metadatas = Nakala::getDataFiles($identifier);
